...
import {
    Card, CardBlock, CardTitle, CardSubtitle, CardGroup,
    Row
} from 'reactstrap';
...
const DisplayStyles = () => (
    <div className="mb-5 col-md-6">
        ...
        <CardSubtitle className="mb-4 small">Use classes <code>display-*</code> to get the result.</CardSubtitle>
...
const HeadingStyles = () => (
    <div className="mb-5 col-md-6">
        ...
        <CardSubtitle className="mb-4 small">Use <code>h1-h6</code> elements or <code>.h1 to .h6</code> classes to get the desired result.</CardSubtitle>
        <h1>h1. First Header</h1>
        <p>Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit.</p>
        <h2>h2. Second Header <small className="text-muted">with subhead</small></h2>
...
const InlineTextStyles = () => (
    <Card className="mb-4">
        <CardBlock>
            ...
            <p className="lead">
                I am a lead paragraph. Slightly bigger than normal body text.
            </p>
...
const BlockquoteStyles = () => (
    <Card className="mb-4">
        <CardBlock>
            ...
            <br/>
            <blockquote className="blockquote">
                <p className="mb-0">Add a <code>&lt;footer class="blockquote-footer"&gt;</code> for identifying the source. Wrap the name of the source work in <code>&lt;cite&gt;</code>.</p>
                <footer className="blockquote-footer">Someone famous in <cite title="Source Title">Source Title</cite></footer>
            </blockquote>
            <blockquote className="blockquote blockquote-reverse">
                <p className="mb-0">Add <code>blockquote-reverse</code> class to make reverse blockquote.</p>
                <footer className="blockquote-footer">Someone famous in <cite title="Source Title">Source Title</cite></footer>
            </blockquote>
        </CardBlock>
    </Card>
