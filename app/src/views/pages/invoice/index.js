            ...
            <Card className="mb-3 invoice-card">
                <CardBlock>
                    <div className="d-flex justify-content-between flex-wrap">
                        <Link to="/">
                            <svg width="46px" height="52px" viewBox="11 4 50 52" style={{'marginLeft': '-4px'}} version="1.1" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <strong className="h2 text-uppercase" style={{color: '#212121'}}>ract</strong>
                        </Link>
                        <div>
